...
experiment('orb.propagators.stateToKepler', () => {
  ...
  test('should return the state vectors of earth after 1yr', (done) => {
    ...
    const testPosition = {
      x: {
        x: -33174954487.989563,
        y: 142330987828.27765,
        z:  16709855816.271286
      },
      v: {
        x: -29497.717773427645,
        y:  -6693.733558959087,
        z:  -1547.1715828752656
      }
    }

    const x = stateToKepler(
      [testPosition.x.x, testPosition.x.y, testPosition.x.z],
      [testPosition.v.x, testPosition.v.y, testPosition.v.z],
      t, m1, m2
    )
